<template>
  <header :class="headerClass">
    <nav class="glass rounded-2xl px-4 py-3 flex items-center justify-between">
      ...
      <div class="flex gap-2 text-sm">
        ...
        <a href="https://github.com/" target="_blank" rel="noreferrer" class="px-3 py-1 rounded-md hover:bg-white/10 text-gray-300 inline-flex items-center gap-1.5">
